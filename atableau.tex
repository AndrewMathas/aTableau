...
% Modified: 15:30 Tuesday, 18 February 2025
% ----------------------------------------------------------------------
...
\end{Example}
  ...
  All keys can be applied to all \aTableau pictures. Most of the time,
  keys that cannot be applied to the current picture are silently
  ignored.
