...
% Modified: 23:42 Tuesday, 07 October 2025
% ----------------------------------------------------------------------
...
\begin{document}
  ...
  \begin{center}
    ...
    \begin{quote}
      ...
      and
        ribbon tableaux.
      This package requires \TeXLive2024 or later.
    \end{quote}
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 horizontal, runner using:
  ...
  \begin{example}[lefthand width=0.2\textwidth, label=Ex:DottedAbacus]
  \Abacus[dotted cols={2,3}, dotted rows={2,3},
    tikz after = {
  ...
  As of writing, the \arXiv now uses \TeXLive2025 by default, so papers
  using \aTableau should compile on the \arXiv. Unfortunately, the
  \arXiv only has version 2.1.0 of \aTableau installed, as this is what
  shipped with \TeXLive2025. If your document does not compile on the
  \arXiv because of \aTableau, you almost certainly need to upload the
  latest \aTableau style file,
