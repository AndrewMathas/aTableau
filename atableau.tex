...
% Modified: 12:03 Tuesday, 02 June 2026
...
\begin{document}
  ...
  \SkewDiagram[entries=columns]{2,1}{3,2,1} \quad
  \SkewDiagram[entries=contents]{2,1}{3,2,1} \quad
  \SkewDiagram[entries=first]{2,1}{4,2,1} \quad
  \SkewDiagram[entries=last]{2,1}{4,2,1} \quad
  \SkewDiagram[entries=residues, e=3]{2,1}{4,2,1} \quad
  \SkewDiagram[entries=rows]{2,1}{4,2,1} \quad
  \end{Example}
...
\end{Example}
  ...
  using \aTableau should compile on the \arXiv. \TeXLive
  will not always have the latest version \aTableau installed.
  If your document does not compile on the \arXiv due to \aTableau,
  check which \TeXLive version is being used. If problems persist,
  try uploading the latest official release of the \aTableau style file,
