...
% Modified: 14:46 Thursday, 02 October 2025
% ----------------------------------------------------------------------
...
% heading linesin tabular environments
...
\begin{document}
  ...
  \begin{itemize}[nosep]
    ...
    with \option{entries=contents} in tableaux
  \end{itemize}
  ...
  individual boxes is often not a good way to add emphasis to a tableau,  so
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 horizontal, runner using:
  ...
  be changed using the \option{beamer} key.  Of course, you also use
