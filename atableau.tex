...
% Modified: 18:26 Wednesday, 14 May 2025
% ----------------------------------------------------------------------
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 horizontal, runner using:
  ...
  abacus, where the runners look like rods and the beads are disc
  shaped. This section describes how to use the \option{traditional}
  key, together with the additional keys for traditional abacuses.

  \option[false]{traditional}[true/false]

  When using the \option{traditional} option, the \keyword{\Abacus}
  commands draw a more  abacus that looks more like  a traditional Chinese
