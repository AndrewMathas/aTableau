...
% Modified: 16:43 Tuesday, 25 February 2025
% ----------------------------------------------------------------------
...
\begin{document}
  ...
  symmetric group and friends, are used. Following the conventions used,
  for example, in~\cite{MathasTubbenhauer:BAD}, residues in affine
  types $C^{(1)}_e$, $A^{(2)}_{2e}$ and $D^{(2)}_e$, are available
  \option{cartan=C}, \option{cartan=AA}, and
  \option{cartan=DD}, respectively.
  ...
  Finally, it is often necessary to label some of the boxes in a ribbon.
  Optionally, text can be added to the boxes in a ribbon by supplying it
  as a \textit{subscript} to the corresponding entry in the ribbon
  specification:
