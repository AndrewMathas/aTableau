...
% Modified: 20:30 Thursday, 13 February 2025
% Modified: 20:30 Thursday, 13 February 2025
...
\begin{document}
  ...
  hatchings styling to the two hooks. Inside the \keyword{tikzpicture}
  ...
  the very readable \TikZ manual if you would like more information
  about the \TikZ-commands used in this example.
  ...
  boxes that have custom styles are placed. (This is discussed in more detail
  in \autoref{SS:order}.)
  ...
  If in doubt, the \option{label} keys should help match each picture
  ...
  \begin{example}
  \Tableau[box style={text=red,draw=teal,shape=circle}]{123,45} \qquad
