...
% Modified: 17:06 Friday, 05 June 2026
...
\begin{document}
  ...
  Here, the \textit{options} are a comma-separated list of
  \aTableau options, or keys, for the default settings. The possible
  options are described below. As an example, to make the tableau and
  ...
  % --------------------------------------------------------------
    ...
    \begin{options}
      ...
      are needed only if the tableau is part of a \keyword{tikzpicture} environment.
...
\end{Example}
  ...
  position), and the use of named coordinates to draw the arrows between beads using the
