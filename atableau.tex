...
% Modified: 11:56 Wednesday, 19 February 2025
% ----------------------------------------------------------------------
...
\begin{document}
  ...
  from removing column, using the $3$ in \option{dotted cols}, because
  ...
  symmetric group and friends, are used. In addition, residues in affine
  types $C^{(1)}_e$, $A^{(2)}_{2e}$ and $D^{(2)}_e$, which can be
  accessed using \option{cartan=C}, \option{cartan=AA}, and
