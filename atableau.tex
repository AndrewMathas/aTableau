...
% Modified: 18:23 Friday, 17 January 2025
% ----------------------------------------------------------------------
...
{%
  ...
  {%
    ...
    \IfNoValueTF{#5} { \AddKeyLink{#3} }{ \AddKeyLink{#3-#5} }
...
\Abacus[north,entries=betas]{2}{4^2,2,1}\qquad\Abacus[west,entries=betas]{2}{4^2,2,1}
 ...
 As one more example, \emph{beta numbers} might be displayed using:
  ...
  \end{example}
  \noindent
  As shown, the beads that correspond to zero parts of the corresponding
  partition are marked with a dash.
  ...
  \option[-]{rows}{non-negative integer}<abacus>
