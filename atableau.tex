...
% Modified: 12:22 Wednesday, 03 June 2026
...
\begin{document}
  ...
  \Diagram[entries=residues, charge=1,
      colours={white,cyan!50,teal!50}]{3,2,1}
  \end{example}
...
\end{Example}
  ...
  The \arXiv now plans to update its \TeXLive distribution annually.
  As of writing, it is using \TeXLive 2025 by default, so papers
  using \aTableau should compile on the \arXiv. The \arXiv
  will not always have the latest version of \aTableau installed.
  If your document does not compile on the \arXiv due to \aTableau,
  check to see if it is using the latest version of \aTableau. If they
  only have an older version of the package available,
  try uploading the latest release of the \aTableau style file,
