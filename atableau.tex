...
% Modified: 13:26 Saturday, 01 November 2025
% ----------------------------------------------------------------------
...
\NewDocumentCommand\ColourTheme{ m }
{
  \begin{samepage}
    ...
    \end{tabular}
    \hfill
    \Abacus[styles={Y={text=yellow}}]{4}{4_u,4_a,4_e,4_l,[Y]4_b,[Y]4_a,[Y]4_T,0_a}\qquad
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 \begin{example}{abacusEndsEast}
  ...
  These commands are provided as a convenience because it is
  possible to define such commands ``by hand'' using
  \keyword{\NewDocumentCommand}. An error is given if the \keyword{\Command}
  being defined by \keyword{\NewATableauCommand} already exists.
...
\end{Example}
  ...
  it a comma separated list of \textit{six colours}, which set the six colours in
