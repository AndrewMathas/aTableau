...
% Modified: 09:02 Thursday, 20 March 2025
% ----------------------------------------------------------------------
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 horizontal, runner using:
  ...
  these keys gives give the ``row index'' for the ends of the runners.
  ...
  \option[0,4]{beam width}[decimal number, width in \unit{cm}]
