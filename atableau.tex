...
% Modified: 09:05 Tuesday, 03 December 2024
% ----------------------------------------------------------------------
...
\end{example}
  ...
  The delimiter options control the delimiters that put on the left and
  right of multitableaux and multidiagrams. These options accept any
  \LaTeX{} delimiter.
  ...
  \Multidiagram[ukrainian,scale=0.5, rows=4.3]{3,2^2|...|2,1^2}
  \end{example}
