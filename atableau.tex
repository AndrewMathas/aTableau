...
% Modified: 10:46 Friday, 21 March 2025
% ----------------------------------------------------------------------
...
\begin{document}
  ...
  contains all of its ribbons.  In the last example, the \option{no
  border} key is used to disable the ribbon tableau border to highlight
  ribbon, which is the full diagram for these two tableaux.
...
\end{Example}
  ...
  \begin{xltabular}{0.9\textwidth}{l>{\raggedright}Xcc}\toprule
    ...
    \option{traditional}       & Use a traditional abacus style                      & \No  & \Yes \\
