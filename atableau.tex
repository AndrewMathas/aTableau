...
% Modified: 13:29 Monday, 23 March 2026
% ----------------------------------------------------------------------
      ...
      \begin{longtable}{lp{0.6\textwidth}l} \toprule % longtable allows footnotes
        ...
        \textcolor{aTableauMain}{Convention} &\textcolor{aTableauMain}{\aTableau command} & \textcolor{aTableauMain}{Picture} \\ \midrule
         \showrowcolors
          ...
          these authors for their government's aggression, so the
          package now uses the more common nomenclature from the literature.}
...
The key features of this example are the use of styles to change the
