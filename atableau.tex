...
% Modified: 22:29 Thursday, 11 June 2026
% ----------------------------------------------------------------------
...
\begin{document}
  ...
  \begin{center}
    ...
    \begin{minipage}{0.75\textwidth}
      ...
      \footnotetext{\copyright\,Copyright \aTableauMeta{copyright}
        \quad\aTableauAuthor\\
        License: \href{https://\aTableauMeta{the README file}}{\aTableauMeta{license}}
      }
    \end{minipage}
  ...
  comma-separated list of non-negative integers, or using exponential
  ...
  Otherwise, the two \keyword{\Diagram} commands in \autoref{diagramCoordinates} below
  ...
  will not actually change the picture.) The use of coordinates become more
  ...
  \begin{warning}
    ...
    \TeXLive 2024. Ideally, you should always use the latest release
    of your preferred \LaTeX\ distribution.
  \end{warning}
  ...
  This means that colours are assigned cyclically:
  \begin{itemize}[nosep]
    \item in increasing order of row index
    \item in decreasing order of column index.
  \end{itemize}
  ...
  Use \option{conjuate} for the ``conjugate'' ladders of slope $1/(e-1)$.
...
\end{Example}
  ...
  following example demonstrates how abacuses are placed using
