...
% Modified: 17:55 Tuesday, 21 January 2025
% ----------------------------------------------------------------------
...
% 2. When #2 is omitted, this this an inline citation of the key. A
% hyperlink is added
...
\begin{document}
  ...
  \begin{center}
    ...
    \begin{quote}
      This package provides commands for drawing Young diagrams,
      tableaux, abacuses, which are common objects used in algebraic
...
%  described in the following sections.
  ...
  \option[\aTableauColour{Main}]{border colour}[\LaTeX~colour]
  ...
  % nodes
  \option[none]{box fill}[\LaTeX~colour]
  ...
  \option[]{box font}[\LaTeX\ font command]
  ...
  \option[\aTableauColour{Main}]{box text}[\LaTeX~colour]
  ...
  \option[\aTableauColour{Inner}]{inner colour}[\LaTeX~colour]
  ...
  You can use \option{inner colour=none}, to remove the inner tableau walls. Alternatively, use \option{no boxes}.

  \begin{example}
  \Tableau[ukrainian, inner colour=none]{123,45,67} \qquad
  \Tableau[ukrainian, no boxes]{123,45,67}
  \end{example}

  \option[]{label}[any character/text]
  \option*[font=\textbackslash scriptsize, text=\aTableauColour{Inner}]{label style}[\TikZ-styling]
  ...
  \option*[-]{path style}[\TikZ-styling]
  ...
  \option*[-]{path box style}[\TikZ-styling]
  ...
  \option*[draw=\aTableauColour{Inner}, thin]{snob style}[\TikZ-styling]
  \option*[-]{snob box}[A node entry]
  \option*[-]{snob box style}[\TikZ-styling]
  ...
  \option[]{ribbons}[list of ribbon specifications]
  \option*[]{paths}[list of ribbon specifications]
  \option*[]{snobs}[list of ribbon specifications]
  ...
  useful to to place boxes outside of the diagrams.

  \option[]{paths}[comma separated ribbon specifications]<ribbons>
  \option*[]{ribbons}[comma separated ribbon specifications]<ribbons>
  \option*[]{snobs}[comma separated ribbon specifications]<ribbons>
...
\end{example}
  ...
  \option[]{paths}[a $|$-separated list of ribbon path specifications]<multi>
  \option*[]{ribbons}[a $|$-separated list of ribbon specifications]<multi>
  \option*[]{snobs}[a $|$-separated list of ribbon specifications]<multi>
...
\Abacus[north,entries=betas]{2}{4^2,2,1}\qquad\Abacus[west,entries=betas]{2}{4^2,2,1}
 ...
 runner using:
  ...
  \option[white]{bead text}[\LaTeX~colour]
  ...
  \option[]{runner labels}{list of labels for the abacus runners}
  \option*[font=\textbackslash scriptsize, text=\aTableauColour{Inner}]{runner label style}[\TikZ-styling]
  ...
  \option*[semithick]{tick style}[\TikZ-styling]
...
\end{Example}
  ...
  \rowcolors{2}{LightSkyBlue!10}{}
  \begin{xltabular}{0.9\textwidth}{lXcc}\toprule
    \large\sffamily\color{MidnightBlue}Key
        & \large\sffamily\color{MidnightBlue} Meaning
        & \large\sffamily\color{MidnightBlue} Tableau
        & \large\sffamily\color{MidnightBlue} Abacus \\
    \midrule
    \endhead
  ...
  \begin{center}
    \begin{tabular}{lll}\toprule
      \large\sffamily\color{MidnightBlue} Colour
      & \large\sffamily\color{MidnightBlue} Name
      & \large\sffamily\color{MidnightBlue} TML\\
       \midrule
  ...
  \begin{center}
    \begin{xltabular}{0.9\textwidth}{ll}\toprule
       \multicolumn1l{\large\sffamily\color{MidnightBlue} Names}
        & \large\sffamily\color{MidnightBlue} Adds \TikZ-styling to...\\
       \midrule
