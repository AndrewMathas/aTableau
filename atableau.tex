...
% Modified: 10:23 Saturday, 05 April 2025
% ----------------------------------------------------------------------
...
\NewDocumentCommand\ColourTheme{ m }
{
  ...
  \bgroup
    ...
    \Abacus[traditional]{4}{4^3,2,1^2,0} \qquad
...
\end{example}
  ...
  now used in the representation theory of many algebras, so their use
  has extended far beyond the symmetric groups.
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 horizontal, runner using:
  ...
  add an offset to the residues, and the \option{cartan} key for
  residues of other affine Cartan types.
  ...
  abacus, where the runners are drawn as rode and the beads are wider.
...
\end{Example}
  ...
  commands and their options. The sections above describe these commands and
  show how their options, or keys, are used, giving many examples.
  ...
  All keys can be used with all \aTableau pictures. Most of the time,
  keys that are not intended to be applied to the current picture will
  be silently ignored.
  ...
  The pictures drawn by \aTableau are drawn using six base colours:
    aTableauMain,
    aTableauInner,
    aTableauStarStyle,
    aTableauSkew,
    aTableauSkewFill,
    aTableauRod,
  Choosing a good colour scheme is difficult, and it is partly
  subjective, so three colour themes are provided . The
  \option{colour theme} key sets the colour theme.
  ...
  theme, the key-value interface allows you to set the colour of the
  individual components of the pictures produced by \aTableau.
  ...
  involved, which is why we do not recommend changing them directly. In
