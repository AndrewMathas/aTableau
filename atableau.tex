...
% Modified: 15:28 Wednesday, 06 August 2025
% ----------------------------------------------------------------------
...
\begin{document}
 ...
 Some \Tableau[align=bottom]{124,357,68} words
  ...
  \begin{warning}
    ...
    affect all \aTableau pictures, including abacuses. It is better to
...
\end{example}
  ...
  \option{text boxes} is true). If a text is preferred, then use
  \option{empty=\text{text}}.
