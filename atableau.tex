...
% Modified: 16:05 Friday, 29 November 2024
% ----------------------------------------------------------------------
...
%  described in the following sections.
  ...
  \option{border=true}, and \option{no border} is equivalent to
  \option{no border=true}. Further, using \option{no border} is
  equivalent to \option{border=false} and, similarly,
  \option{border} is equivalent to \option{no border=false}.
  ...
  Setting the \option{left delimiter} or \option{right delimiter} to
  nothing removes the delimiter.
  ...
  \option{separator=e} draws a straight line between the
