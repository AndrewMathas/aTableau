...
% Modified: 09:58 Thursday, 06 March 2025
% ----------------------------------------------------------------------
...
\newenvironment{warning}{\list{\textcolor{red}{\textdbend}\quad}{\leftmargin=3em}\item}{\endlist}
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
  ...
  \begin{quote}
    ...
    \begin{tabular}{Oll} \toprule
      ...
      $-$    & dash         & Adds a line that extends slightly past the first and last runners\\
      \_\!\_ & underscore   &  Adds a line between the first and last runners\\
      .      & dot          & Add dots to the end of each runner\\
      *      & asterisk     & Add dots and an arrow to the end of each runner\\
      $|$    & pipe         & Runners do not have any additional decoration\\
      $>$    & greater than & Add arrows to the end of each runner\\
      \bottomrule
    \end{tabular}
  \end{quote}
...
\end{Example}
  ...
  \begin{center}
    \begin{xltabular}{0.9\textwidth}{ll}\toprule
       ...
       aTableau/standardBead     & Standard abacus beads\\
       aTableau/standardRunner   & Standard abacus runners\\
       aTableau/standardTick     & Standard abacus ticks \\
       aTableau/tableauStarStyle & Star style for tableaux \\
       aTableau/traditionalBead  & Traditional abacus beads\\
       aTableau/traditionalRunner& Traditional abacus runners\\
       aTableau/traditionalTick  & Traditional abacus ticks \\
       \bottomrule
    \end{xltabular}
  \end{center}
  ...
  should give the error. This is necessary because if we cannot reproduce
  your problem, then it is unlikely that we will be able to fix it.
