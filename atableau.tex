...
% Modified: 18:42 Tuesday, 01 April 2025
% ----------------------------------------------------------------------
...
\NewDocumentCommand\ColourTheme{ m }
{
  \bgroup
    ...
    \Abacus[traditional]{4}{4^3,2,1^2,0} \quad
    \Abacus{4}{4^3,2,1^2,0} \quad
    \Multitableau[tabloid]{ 123,45 | 67,89} \quad
    \SkewTableau[skew~boxes, skew~border] {2,1^2}{123,45,67}
