...
% Modified: 13:55 Friday, 12 December 2025
% ----------------------------------------------------------------------
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 \begin{example}{abacusEndsEast}
  ...
  The commands created using \keyword{\NewATableauCommand} are are used
...
which use abacuses like the following~\cite[page~305]{FayersPutignano:CentraliserAlgebras}:
