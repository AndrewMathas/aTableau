...
% Modified: 22:44 Wednesday, 01 October 2025
% ----------------------------------------------------------------------
...
\NewTColorBox[]{slide}{ O{} }
{
  ...
  coltitle=NavyBlue,
  fonttitle=\bfseries,
  attach boxed title to bottom right={xshift=-1em,yshift=2.5mm},
  boxed title style={
    size=tight,
    arc=1mm,
    bottom=1mm,
    ...
    interior style={
        fill=none,
        bottom color=Cornsilk!50!white,
        top color=Cornsilk
    }
  },
  #1
...
The final example shows how to draw the KLRW diagram associated to a
multipartition~\cite{Bowman:ManyCellular}.
