...
% Modified: 10:36 Wednesday, 19 March 2025
% ----------------------------------------------------------------------
...
\begin{document}
  ...
  the \keyword{\aTabset} command, and you can change the options for any
  \aTableau picture.
  \indexcmd{aTabset}
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 horizontal, runner using:
  ...
  Some of the \option{abacus ends} are not compatible with the
  \option{traditional} key, for which \option{framed} may be a better
  option.
...
\end{Example}
  ...
  \keyword{\tikzset}, but there is a risk that you may break some of the
  corresponding \aTableau commands if you do this. If you do change
  these styles, we strongly recommend that you \emph{append} to these
  styles rather than setting them directly.
