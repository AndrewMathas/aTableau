...
% Modified: 16:43 Friday, 22 November 2024
% ----------------------------------------------------------------------
...
%  described in the following sections.
  ...
  this code is executed before the tableau is drawn, which is when these
  nodes are constructed. For examples, see \autoref{SS:order}.
  ...
  should be connected. (For disconnected diagrams, see
  ...
  of earlier ones, sometimes obscuring earlier features. For this reason
  it is useful to know the drawing order used by
  \keywords{\Tableau}:
  \begin{itemize}
