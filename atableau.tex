...
% Modified: 18:18 Tuesday, 25 February 2025
% ----------------------------------------------------------------------
...
\begin{document}
  ...
  This package provides commands for drawing common objects in algebraic
...
\end{example}
  ...
  \begin{example}
  \begin{tikzpicture}[add grid]
    \aTabset{abacus ends=_|, entries=betas}
  ...
  As described below, using \option{entries=betas}<abacus> labels each bead with the corresponding
  \emph{beta number}.
