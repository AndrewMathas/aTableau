...
% Modified: 00:10 Saturday, 06 June 2026
% Package meta data comes from atableau.ini via \aTableauMeta
% ----------------------------------------------------------------------
...
\begin{document}
  ...
  \option[]{entries=value}[columns, contents, first, hooks, last, residues, rows]
