...
% Modified: 19:01 Saturday, 02 August 2025
% ----------------------------------------------------------------------
...
\begin{document}
 ...
 Some \Tableau[align=bottom]{124,357,68} words
  ...
  type. When using other Cartan types you will need to manually set the
  quantum characteristic \option{e} \textit{after} specifying the list
  of~\option{colours}.
...
\Abacus[north,entries=beads]{2}{4^2,2,1}\qquad\Abacus[west,entries=beads]{2}{4^2,2,1}
 ...
 horizontal, runner using:
  ...
  traditional-style abacus, where the runners look like rods, and the
  beads look like discs. The result is more visually appealing, except
  possibly for the choice of colours!
  ...
  \begin{center}
    \begin{tabular}{*5l}
      Abacus& Diagram& Multidiagram& Multitableau& ShiftedDiagram\\
      ShiftedTableau& SkewDiagram& SkewTableau& Tableau& Tabloid
    \end{tabular}
  \end{center}
  ...
  modify your ``design specifications'' of your custom tableaux because
  they will appear only in the definition of your custom command.
  ...
  interface, which is another reason to avoid changing them by hand.
  Changes that you make to these styles are not guaranteed to be
